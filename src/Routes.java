...
public class Routes {
    ...
    public static Character buscarPersonagemPorNome(String nome) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                return new Character(name, age, strength, speed, life, level);
            }
    ...
    public static Tournament buscarTorneioPorNome(String nome) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                TournamentIndividual tournamentIndividual;
                TournamentTeam tournamentTeam;

                if (type.equalsIgnoreCase("Individual")) {
                    int rounds = rs.getInt("rodadas");
                    tournamentIndividual = new TournamentIndividual(name, prize, maxParticipants, rounds);
                } else {
                    tournamentTeam = new TournamentTeam(name, prize, maxParticipants);
                }
            }
        } catch (SQLException e) {
            e.printStackTrace();
    ...
    public static Technique buscarTecnicaPorNome(String nome) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                return new Technique(name, power, energyCost, type, cooldown, description);
            }
